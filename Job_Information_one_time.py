...
update_these_links = pull_active_jobs_append_new_job_list('listing_page_data')
...
if __name__ == '__main__':
    ...
    df_jd_1.to_csv(r"/home/ec2-user/scrape_data/job_information_updated/job_information_updated_0_5000_{}.csv".format(str(date.today())),index=False)
...
if __name__ == '__main__':
    ...
    df_jd_2.to_csv(r"/home/ec2-user/scrape_data/job_information_updated/job_information_updated_5000_10000_{}.csv".format(str(date.today())),index=False)
...
if __name__ == '__main__':
    ...
    df_jd_3['job_reference_number'] = df_jd_3['job_reference_number'].astype('string').apply(lambda x: fixing_job_ref(x))
    df_jd_3.to_csv(r"/home/ec2-user/scrape_data/job_information_updated/job_information_updated_10000_more_{}.csv".format(str(date.today())),index=False)
